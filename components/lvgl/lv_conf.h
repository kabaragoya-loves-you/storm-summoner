...
/** Align stride of all layers and images to this bytes */
    ...
    #if ENABLE_SPI_DMA == 1
        #define LV_DRAW_BUF_STRIDE_ALIGN 4  /* 4-byte alignment for DMA */
    #else
        #define LV_DRAW_BUF_STRIDE_ALIGN 1  /* No DMA, no alignment needed */
    #endif
#else
    #define LV_DRAW_BUF_STRIDE_ALIGN 1      /* Default: no alignment */
#endif
 ...
 */
#define LV_DRAW_THREAD_STACK_SIZE    (32 * 1024)        /**< [bytes] - 32KB for ThorVG/SVG support */
...
#if LV_USE_SYSMON
    /** Get the idle percentage - disabled, use 'cpu' command for accurate FreeRTOS stats */

 ...
 * - REV_3: 2.2k bottom resistor (~0.595V, ~785 ADC counts)
 * - REV_4: 3.3k bottom resistor (~0.819V, ~1083 ADC counts)
 * - REV_5: 5.1k bottom resistor (~1.114V, ~1473 ADC counts)
 */
typedef enum {
  HW_REV_UNKNOWN = 0,
  HW_REV_1 = 1,
 ...
 * Reads the voltage divider on PIN_REVISION and determines hardware version

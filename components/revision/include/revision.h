 ...
 * - REV_9: 220 ohm bottom resistor (~0.071V, ~71 ADC counts)
 * - REV_10: 1.0k bottom resistor (~0.3V, ~396 ADC counts)
 * - REV_11: 3.3k bottom resistor (~0.819V, ~1083 ADC counts)
 * - REV_12: 5.1k bottom resistor (~1.114V, ~1473 ADC counts)
 * - REV_13: 10k bottom resistor
 */
typedef enum {
  HW_REV_UNKNOWN = 0,
  HW_REV_9 = 1,
...
/**
 * Get the hardware revision as a string (e.g., "Rev 9", "Rev 10")

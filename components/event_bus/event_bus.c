...
static const char* event_type_names[] = {
  ...
  [EVENT_BUTTON_L_RELEASE] = "BUTTON_L_RELEASE",
  [EVENT_BUTTON_R_RELEASE] = "BUTTON_R_RELEASE",
  [EVENT_BUTTON_BOTH_RELEASE] = "BUTTON_BOTH_RELEASE",
  ...
  [EVENT_SYNC_STATE_CHANGED] = "SYNC_STATE",
  ...
  [EVENT_SCENE_REORDERED] = "SCENE_REORDERED",
  [EVENT_SCENE_LIST_CHANGED] = "SCENE_LIST_CHANGED",
  // Transport events
  ...
  [EVENT_TRANSPORT_POSITION_CHANGED] = "TRANSPORT_POS",
  // Tempo/timing events
  [EVENT_BEAT] = "BEAT",

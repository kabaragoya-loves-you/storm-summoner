...
typedef enum {
  ...
  EVENT_TRANSPORT_POSITION_CHANGED,
  ...
  EVENT_BUTTON_L_RELEASE,
  EVENT_BUTTON_R_RELEASE,
  EVENT_BUTTON_BOTH_RELEASE,
  EVENT_MIDI_ACTION,
  EVENT_UI_ACTION,
  EVENT_SENSOR_ALS,
...
typedef struct {
  ...
  union {
    ...
    struct {
      ...
      uint8_t is_fresh_start; // 1 = playback began from STOPPED (On-Play fires)
    } transport;

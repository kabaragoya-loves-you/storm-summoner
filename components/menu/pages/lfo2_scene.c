...
static continuous_mapping_t* lfo2_flag_mapping(scene_t* scene) {
  return scene ? &scene->lfo2 : NULL;
}
...
lv_obj_t* menu_page_lfo2_scene_create(void) {
  ...
  continuous_flag_ctx_set(&(continuous_flag_ctx_t){
    .get_mapping = lfo2_flag_mapping,
    .parent_title = "LFO2",
    .parent_create = menu_page_lfo2_scene_create,
  ...
  if (scene->lfo2_config.waveform != LFO_WAVEFORM_GLIDER) {

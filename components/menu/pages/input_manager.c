...
static void set_mode_cv(void) { input_set_mode(INPUT_MODE_CV); ESP_LOGI(TAG, "Mode: CV"); }
static void set_mode_clock(void) { input_set_mode(INPUT_MODE_CLOCK_SYNC); ESP_LOGI(TAG, "Mode: Clock Sync"); }
static void set_mode_audio(void) { input_set_mode(INPUT_MODE_AUDIO); ESP_LOGI(TAG, "Mode: Audio"); }
static void set_mode_note(void) { input_set_mode(INPUT_MODE_NOTE); ESP_LOGI(TAG, "Mode: Note"); }
...
lv_obj_t* menu_page_input_manager_create(void) {
  ...
  static menu_item_t input_items[] = {
    ...
    { "Mode: CV", set_mode_cv, false },
    { "Mode: Clock", set_mode_clock, false },
    { "Mode: Audio", set_mode_audio, false },
    { "Mode: Note", set_mode_note, false }
  };

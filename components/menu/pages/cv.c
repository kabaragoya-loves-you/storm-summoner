...
static void set_range_10v(void) { cv_set_range(CV_RANGE_10V); ESP_LOGI(TAG, "Range: 0-10V"); }
static void set_range_bi10v(void) { cv_set_range(CV_RANGE_BIPOLAR_10V); ESP_LOGI(TAG, "Range: ±10V"); }
static void set_range_5v(void) { cv_set_range(CV_RANGE_5V); ESP_LOGI(TAG, "Range: 0-5V"); }
static void set_range_bi5v(void) { cv_set_range(CV_RANGE_BIPOLAR_5V); ESP_LOGI(TAG, "Range: ±5V"); }
static void set_range_3v3(void) { cv_set_range(CV_RANGE_3V3); ESP_LOGI(TAG, "Range: 0-3.3V"); }
...
lv_obj_t* menu_page_cv_create(void) {
  ...
  static menu_item_t cv_items[] = {
    ...
    { "Range: 0-10V", set_range_10v, false },
    { "Range: ±10V", set_range_bi10v, false },
    { "Range: 0-5V", set_range_5v, false },
    { "Range: ±5V", set_range_bi5v, false },
    { "Range: 0-3.3V", set_range_3v3, false },

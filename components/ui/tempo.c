...
static ui_module_setting_t tempo_settings[] = {
...
static const size_t tempo_settings_count = sizeof(tempo_settings) / sizeof(tempo_settings[0]);
...
static void tempo_teardown(void) {
  ...
  // Unregister settings
  ui_module_unregister_settings("tempo");
...
static void tempo_ui_init(void) {
  ...
  ui_module_register_settings("tempo", tempo_settings, tempo_settings_count);
